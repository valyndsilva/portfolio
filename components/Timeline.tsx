...
function Timeline({ item, index }: Props) {
  return (
    <div className="relative z-10">
      <div className="w-16 h-16 rounded-full shadow-md text-center absolute left-[50%] top-5 ml-[-2rem] items-center justify-center border-2 border-teal-400 bg-white hover:bg-teal-50 dark:bg-slate-700 mb-5 flex-shrink-0 hidden md:inline-flex cursor-pointer">
      ...
      >
        ...
        <div className="relative group  opacity-70 hover:opacity-100 dark:opacity-40 dark:hover:opacity-100  cursor-pointer transition-opacity duration-200">
          ...
          <div className="bg-white border border-teal-200 dark:border-none dark:bg-slate-800 rounded-md shadow-md  p-6 text-left relative">
