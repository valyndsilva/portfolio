            ...
            <SwiperSlide>
              <div className="flex flex-col  w-full md:w-2/3 mx-auto justify-center items-center text-center p-10 dark:bg-slate-800 rounded-lg font-firacode">
                ...
                <p className="leading-relaxed text-md dark:text-slate-400">
                  ...
                  involved as well as being clearly integrated with the team.
                  Her hard work and passion, always pursuing perfection, will
                  make Valyn a true asset for your company.”
                </p>
            ...
            <SwiperSlide>
              <div className="flex flex-col w-full md:w-2/3 mx-auto  justify-center items-center text-center  p-10 dark:bg-slate-800 rounded-lg font-firacode">
                ...
                <p className="leading-relaxed text-md dark:text-slate-400 ">
                  ...
                  intelligent, detail oriented and precise Front-End Developer
                  with very good communication skills. Always takes care of the
                  job, works hard and really enjoys team-working and is always a
