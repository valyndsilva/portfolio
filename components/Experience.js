        ...
        <Fade direction="left" duration={2200}>
          ...
          >
            {experienceInfo?.map((experience) => (
              <div key={experience.jobId}>
                <h2 id={`accordion-collapse-heading-${experience.jobId}`}>
                  <button
                    type="button"
                    ...
                    data-accordion-target={`#accordion-collapse-body-${experience.jobId}`}
                    aria-expanded="true"
                    aria-controls={`accordion-collapse-body-${experience.jobId}`}
                  >
                ...
                <div
                  id={`accordion-collapse-body-${experience.jobId}`}
                  className=""
                  aria-labelledby={`accordion-collapse-heading-${experience.jobId}`}
                >
